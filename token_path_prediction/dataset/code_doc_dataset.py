...
import logging
from token_path_prediction.utils.dist_utils import get_total_world_size, get_world_rank
from transformers.data.data_collator import _torch_collate_batch, tolist
from token_path_prediction.modules.utils import *
...
class RainbowBankDataset(Dataset):
    def __init__(self,
                 data_dir: str,
                 data_processor,
                 dataset_name="data.train.txt",
