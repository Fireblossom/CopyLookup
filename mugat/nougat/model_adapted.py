...
import math
import os
import mugat.nougat.adapter as adapter
...
from mugat.nougat.postprocessing import postprocess
from mugat.nougat.transforms import train_transform, test_transform
...
class NougatConfig(PretrainedConfig):
    ...
    Args:
        input_size:
            Input image size (canvas size) of mugat.nougat.encoder, SwinTransformer in this codebase
        align_long_axis:
            Whether to rotate image if height is greater than width
        window_size:
            Window size of mugat.nougat.encoder, SwinTransformer in this codebase
        encoder_layer:
            Depth of each mugat.nougat.encoder Encoder layer, SwinTransformer in this codebase
        decoder_layer:
            Number of hidden layers in the mugat.nougat.decoder, such as BART
        max_position_embeddings
