...
class ErnieLayoutTokenizerFast(XLNetTokenizerFast):
    ...
    def _batch_encode_plus(
        ...
        for batch_index in range(len(sanitized_tokens["input_ids"])):
            ...
            for id, sequence_id, word_id in zip(
                ...
                if word_id is not None:
                    if is_pair and sequence_id == 0:
                        ...
                        token_boxes_mapping_example.append(-100)
                    else:
                        token_boxes_example.append(boxes[original_index][word_id])
                        token_boxes_mapping_example.append(word_id)
                else:
                    token_boxes_mapping_example.append(-100)
            ...
            token_boxes_mapping.append(token_boxes_mapping_example)

        sanitized_tokens["bbox"] = token_boxes
        sanitized_tokens["token_in_bboxes"] = token_boxes_mapping
