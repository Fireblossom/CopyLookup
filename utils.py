...
if __name__ == "__main__":
    preditions = torch.LongTensor([[-100,0,0,1,1,-100], [-100,0,0,-100,-100,-100], [-100,0,0,1,-100,-100]])
    token_in_bboxes = torch.LongTensor([[-100,0,0,1,1,-100], [-100,0,1,-100,-100,-100], [-100,0,1,2,-100,-100]])
    labels = torch.LongTensor([[-100,0,0,1,1,-100], [-100,0,0,-100,-100,-100], [-100,0,1,1,-100,-100]])
    box_preds_tensor, box_labels_tensor, box_token_counts_tensor = compute_box_predictions(preditions.cuda(), token_in_bboxes.cuda(), 2, labels.cuda())
    print(box_preds_tensor, box_labels_tensor, box_token_counts_tensor)
    box_labels_tensor[box_token_counts_tensor < 2]=-100
    print(box_labels_tensor)